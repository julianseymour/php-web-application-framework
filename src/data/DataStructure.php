...
StaticPermissionGatewayInterface{
	...
	protected function beforeCreateTableHook(mysqli $mysqli): int{ //XXX I can't imagine a situation where this would be useful
	...
	public final function load(mysqli $mysqli, $where, $params, $order_by = null, $limit = null): int{
		...
		try{
			...
			}elseif($where instanceof WhereCondition){
				if($print){
	...
	public function delete(mysqli $mysqli): int{
		...
		try{
			...
			$typedef = $this->getColumn($this->getIdentifierName())->getTypeSpecifier();
