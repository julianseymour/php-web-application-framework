...
if(!defined("FILE_CACHE_ENABLED")){
	define("FILE_CACHE_ENABLED", CACHE_ENABLED);
}
if(!defined("HTML_CACHE_ENABLED")){
	define("HTML_CACHE_ENABLED", FILE_CACHE_ENABLED);
}
if(!defined("QUERY_CACHE_ENABLED")){
	define("QUERY_CACHE_ENABLED", CACHE_ENABLED);
}
if(!defined("JAVASCRIPT_CACHE_ENABLED")){
	define("JAVASCRIPT_CACHE_ENABLED", FILE_CACHE_ENABLED);
}
if(!defined("CSS_CACHE_ENABLED")){
	define("CSS_CACHE_ENABLED", FILE_CACHE_ENABLED);
}
if(!defined("JSON_CACHE_ENABLED")){
	define("JSON_CACHE_ENABLED", FILE_CACHE_ENABLED);
}
if(!defined("USER_CACHE_ENABLED")){
	define("USER_CACHE_ENABLED", CACHE_ENABLED);
}
...
if(!defined("SESSION_TIMEOUT_SECONDS")){
	define("SESSION_TIMEOUT_SECONDS", ini_get('session.gc_maxlifetime'));
}else{
...
if(!defined("LOCALE_DEFAULT")){
	define("LOCALE_DEFAULT", LANGUAGE_DEFAULT."_".REGION_DEFAULT);
}
if(!defined("DISABLE_UNLISTENED_EVENTS")){
	define("DISABLE_UNLISTENED_EVENTS", false);
}
if(!defined("BACKWARDS_REFERENCES_ENABLED")){
	define("BACKWARDS_REFERENCES_ENABLED", false);
}
if(!defined("DEBUG_MODE_ENABLED")){
	define("DEBUG_MODE_ENABLED", false);
}
if(!defined("SUPPLEMENTAL_GARBAGE_COLLECTION_ENABLED")){
	define("SUPPLEMENTAL_GARBAGE_COLLECTION_ENABLED", false);
}
if(!defined("DEBUG_REFERENCE_MAPPING_ENABLED")){
	define("DEBUG_REFERENCE_MAPPING_ENABLED", DEBUG_MODE_ENABLED && SUPPLEMENTAL_GARBAGE_COLLECTION_ENABLED);
}
