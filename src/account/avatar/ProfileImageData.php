...
class ProfileImageData extends ImageData implements TemplateContextInterface
{
	...
	{
		$f = __METHOD__; //ProfileImageData::getShortClass()."(".static::getShortClass().")->getArrayMembershipConfiguration({$config_id})";
		try {
	...
	{
		$f = __METHOD__; //ProfileImageData::getShortClass()."(".static::getShortClass().")->beforeInsertHook()";
