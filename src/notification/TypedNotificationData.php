...
abstract class TypedNotificationData extends NotificationData 
implements StaticSubtypeInterface, TemplateContextInterface{
	...
	public static function reconfigureColumns(array &$columns, ?DataStructure $ds = null): void{
		...
		try{
			...
			$columns['subtype']->setValue(static::getSubtypeStatic());
		}catch(Exception $x){
			x($f, x);
		}
	}
