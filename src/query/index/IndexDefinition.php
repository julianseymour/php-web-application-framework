...
class IndexDefinition extends Basic implements ArrayKeyProviderInterface, SQLInterface{
	...
	public function getIndexDefinitionString():string{
		$string = "";
	...
	public function getIndexOptionsString():string{
		$f = __METHOD__;
		$string = " (";
		$i = 0;
	...
	public function setHideIndexNameFlag(bool $value = true):bool{
		return $this->setFlag("hideIndexName", $value);
	}

	public function getHideIndexNameFlag():bool{
	...
	public function setParserName($name){
		...
		}elseif($this->hasParserName()){
			$this->release($this->parserName);
		}
		return $this->parserName = $this->claim($name);
	}

	public function hasParserName():bool{
