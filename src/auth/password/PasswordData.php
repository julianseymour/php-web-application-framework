...
class PasswordData extends DataStructure{
	 ...
	 */
	public static function generate($password, $storage_keypair = null, $crypto_sign_seed = null):?PasswordData{
		$f = __METHOD__;
		try{
			$print = false;
			// 1. generate 2 nonces as salt
	...
	protected static function getExcludedConstructorFunctionNames():?array{
		return array_merge(parent::getExcludedConstructorFunctionNames(), ["generate"]);
	}
