...
define("DIRECTIVE_ALTER_ROUTINE", "alter routine");
define("DIRECTIVE_ALTER_TABLE", "alter");
define("DIRECTIVE_CREATE_ROUTINE", "create routine");
define("DIRECTIVE_CREATE_TABLE", 'create');
define("DIRECTIVE_CREATE_USER", "create user");
...
define("DIRECTIVE_REFERENCES", "references");
