...
class EmailNotificationSettingsForm extends ExpandingMenuNestedForm{
	...
	public function __construct($mode = ALLOCATION_MODE_UNDEFINED, $context = null){
		...
		$this->setIdAttribute("email_notification_settings_form");
	...
	public static function getExpandingMenuRadioButtonIdAttribute(){
		return "radio_settings_email_notifications";
	}
